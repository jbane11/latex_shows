	...
	\column{0.48\textwidth}
		\begin{block}{}
			\begin{itemize}
				...
				\item [] \hspace{-15pt}\textbf{MARATHON planned to use}
				\item 11 GeV Beam	
...
\begin{figure}
	\includegraphics[width=10cm]{../images/total_xs.pdf}
\end{figure}
\end{frame}
%----------------------------------------------
\begin{frame}{}
\frametitle{Error Contributions for Cross Section}

\end{frame}
%----------------------------------------------
\begin{frame}{}
\frametitle{Cross Section Ratio}
\begin{figure}
	\includegraphics[width=10cm]{../images/EMC.pdf}
\end{figure}
...
\begin{columns}
	...
	\end{figure}
	\column{0.5\textwidth}
	$\bullet$ Correct for the unequal number of nucleons in the A/D ratio.	
\end{columns}
