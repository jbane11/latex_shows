...
%------------------------------------------------------------------
\begin{frame}
\frametitle{Yield Extraction}
	\begin{block}{}
		Cross section by Monte carlo ratio  method:
		
			$ \frac{d\sigma}{d\Omega dE^\prime} = \sigma^{mod} * \left[\frac{Yield_{data} \left( E^\prime,\theta\right)} {Yield_{MC}\left(E^\prime,\theta\right)}\right] $
	...
	Number of detected Electrons
		...
		$ Yield_{data} = \frac{\left(N_e - BackGround\right)}{Efficency }   $
...
\begin{frame}
	\begin{block}{Timeline}
		...
		\vspace{-5pt}
		\parallelitem{Monte Carlo Tunning $ \approx 85 \%$}{ January 2018}
		\vspace{-5pt}
		\parallelitem{Detector Efficiencies $ \approx 50 \%$}{ February 2018}
%		\hspace{10pt}	
		\vspace{-8pt}	
		\begin{columns}
		...
		\end{columns}
		\vspace{-10pt}
		\parallelitem{Systematic Studies $ \approx 50 \%$  Need to focus on error estimation.}{ February 2018}
		\vspace{-5pt}
		\parallelitem{Acceptance Studies using Monte Carlo $ \approx 75 \%$ Finish tunning to move forward}{Feb. - March 2018}
