...
\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
	...
	\begin{block}{}
	In 1983, the European Muon Collaboration (EMC) published their experimental results for the Nuclear structure functions of Iron and Deuterium. This data was used to determine:
		\begin{itemize}
	...
	\begin{figure}
		\caption{\label{EMC} EMC data of $ F_2^{Fe}/F_2^{D}$  from 1982.}
	 \includegraphics[width =6cm]{/home/jbane/latex_shows/images/EMC_cc}
	 \end{figure}
...
\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
	...
	European Muon Collaboration:
		...
		\item Becasue the binding energies of the nucleons are several orders of magnitude smaller then the momentum transfer for an interaction
		\item Fermi interaction causing differentiation at high moment transfer. 
		\end{itemize}
	\end{block}
	...
	\begin{figure}
		\caption{\label{EMC1} EMC data of $ F_2^{Fe}/F_2^{D}$  from 1982.}
		\includegraphics[width =6cm]{/home/jbane/latex_shows/images/EMC_cc_mod.jpg}
	 \end{figure}
