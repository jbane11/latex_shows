...
\frametitle{Vertical Drift Chamber(VDC)}
	\begin{columns}
		...
		\begin{itemize}
			...
			\item Online Efficiency determined by nearest neighbor method 
		\end{itemize}
	\end{columns}
\end{frame}
%---------------------------------------------------------------
...
\frametitle{Gas Cherenkov}
	...
	\begin{columns}
		...
		\begin{itemize}
			...
			\item Electron threshold of 0.017 GeV/c
			\item Pion/proton threshold  of 4.8/32 GeV/c
			\item 1.5/1 m radiator length of left/right arm 
	...
	\begin{columns}
		...
		\begin{block}{}
			\begin{itemize}
				...
				\item Provide TOF(time of flight) $\&$ Used to help identify hadrons
			\end{itemize}
