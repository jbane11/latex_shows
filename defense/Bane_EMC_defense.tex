...
\begin{columns}[t]
	...
	$\bullet$ \textbf{\textcolor{ForestGreen}{Elastic scattering}}
	\begin{figure}[]
		\includegraphics[width=3.5cm,height=3cm]{../images/elast_draw.png}
	\end{figure}}
	\column{.33\textwidth} % Left column and width
		\only<2>{
...
%	\vspace{-10pt}
	\begin{figure}[]
		\includegraphics[width=3.5cm,height=3cm]{../images/quais_draw.png}
	\end{figure}}
	\column{.33\textwidth} % Left column and width
		\only<3>{
	$\bullet$ \textbf{\textcolor{blue}{DIS}}
%	\vspace{8pt}
	\begin{figure}[]
		\includegraphics[width=3.5cm,height=3cm]{../images/dis_draw.png}
	\end{figure}}
	...
	\begin{columns}
		...
		\begin{itemize}
			\onslide<2->\item Use well defined samples from separate system(s)
						...
						\only<3>{
				\item Testing cherenkov $\rightarrow$ calorimeters
				\item Testing VDC use scintillators. }
...
\begin{block}{Summary}
	\begin{itemize}
		...
		\item Looked at the A/D ratio for both $^3$H and $^3$H3
