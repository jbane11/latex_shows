...
\begin{table}[]
	\caption*{Relative Error Contributions for Cross Section for a selection of bins.}
	\begin{tabular}{|p{2.2cm}|l|l|l|l|l|l|}
		...
		\textbf{Yield Error} & 0.01 & 0.01  & 0.014 & 0.015 & 0.014 & 0.016\\ \hline
				Stat Err*   & 0.0062         & 0.0053         & 0.0097        & 0.0106        & 0.011          & 0.0143         \\ \hline
				End Cap*            & 0.007          & 0.007          & 0.007         & 0.007         & 0.0070         & 0.007          \\ \hline
		Eff Err*             & 0.004          & 0.0051         & 0.0075        & 0.0071        & 0.0041         & 0.0032         \\ \hline \hline
		\textbf{MC\&Model}   & 0.015 & 0.015 & 0.013 & 0.014 & 0.028 & 0.026\\ \hline
		Resolution**                       & 0.015          & 0.011          & 0.006         & 0.004         & 0.007          & 0.02           \\ \hline
		Model Err**                    & 0.002          & 0.01           & 0.011         & 0.011         & 0.027          & 0.018          \\ \hline \hline
		
		\textbf{Total Error}  & 0.018 & 0.018 & 0.019 & 0.021 & 0.031 & 0.031\\ \hline
	\end{tabular}

	* Part of the error in the yield calculation\\
	** Part of the error in Monte Carlo and Cross section model calculation. 
...
\begin{figure}
	\includegraphics[width =11cm]{../images/ISOfacs.pdf}
...
\begin{frame}{}
\begin{figure}
	\includegraphics[width=10cm]{../images/Thesis/A_ratios.pdf}
	\caption*{Ratio of $^3$H/$^3$H3 EMC effects}
\end{figure}
\end{frame}
...
\begin{block}{Conclusion}
	\begin{itemize}
		\item Used DIS to extract inclusive cross section for $^3$H, $^3$H3, and D
...
\vspace*{-8pt}
		\bibitem[Aubert, J.J. et al. 1981]{cc} Aubert, J.J. et al.
